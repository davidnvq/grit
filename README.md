...
> **will be reformatted into a table**. The checkponits are currently stored temporarily on Google Drive with limited space (will be updated with better location).
...
- checkpoint for GRIT on image caption (using detector on VG): [checkpoint](https://drive.google.com/file/d/1ViqBJ_i9CVABpy48pOAC1MDHZ6e5Zj1v/view?usp=sharing).
- checkpoint for GRIT on image caption (using detector on 4DS): [checkpoint](https://drive.google.com/file/d/1WLsMrtVFTftSJiGHg7iALNFImtefHtOT/view?usp=sharing). 
